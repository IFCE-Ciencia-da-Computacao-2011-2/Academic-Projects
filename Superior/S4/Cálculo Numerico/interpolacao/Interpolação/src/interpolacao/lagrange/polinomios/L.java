...
public class L {
	...
	public L(int index, Polinomio numerador, double denominador, String concatenaNumerador, String concatenaDenominador) {
		this.index = index;
	...
	public Polinomio resultado() {
		Monomio denominador = new Monomio(denominador(), 0);
