...
import br.edu.ifce.estrutura.lista.Lista;
...
public class Listas extends TestCase {
	
	@Parameters
	public static Collection<Object[]> parameters() {
		List<Lista<String>> listasTestadas = new ArrayList<>(10);
		...
		for (Lista<String> lista : listasTestadas)
	...
	public Listas(Lista<String> lista) {
		this.lista = lista;
	}
	...
	private static void manualClear(Lista<?> lista) {
		while (lista.size() != 0)
			lista.remove(0);
	}
