...
proc vTclWindow.top32 {base} {
    ...
    listbox $site_3_0.lis52 \
        -background white 
    vTcl:DefineAlias "$site_3_0.lis52" "Listbox2" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lis51 \
        -in $site_3_0 -x 10 -y 50 -anchor nw -bordermode ignore 
    place $site_3_0.lis52 \
        -in $site_3_0 -x 220 -y 50 -anchor nw -bordermode ignore 
    ...
    place $top.tLa46 \
        ...
        -bordermode ignore 
    place $top.cpd47 \
        -in $top -x 136 -y 80 -anchor nw -bordermode inside 
    place $top.cpd48 \
        -in $top -x 136 -y 110 -anchor nw -bordermode inside 
    place $top.cpd49 \
        -in $top -x 230 -y 10 -anchor nw -bordermode inside 
    place $top.cpd50 \
        -in $top -x 20 -y 10 -anchor nw -bordermode inside 
    place $top.tBu53 \
